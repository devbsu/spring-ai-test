...
public class InternetSearchTools {
  private String searchEndpoint; // 엔드 포인트
  private String apiKey; // api키
  private String engineId; // 구글에서만 사용: api는 하나인데, 검색 엔진에 이름을 달아 각 프로젝트별로 사용할 수 있다
  private WebClient webClient;
  private ObjectMapper objectMapper = new ObjectMapper(); // json을 java 객체로 파싱
